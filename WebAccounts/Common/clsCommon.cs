...
namespace WebAccounts.Common
{
    public class clsCommon
    {
        ...
        {
            return SetXMLAttributes(LsColumnName, LsColumnValue, LbWithCDATA, true);
        }
        public string SetXMLAttributes(string LsColumnName, string LsColumnValue, bool LbWithCDATA, bool LbAppendNewLine)
        {
            string LsNewLine = "";
            if (LbAppendNewLine) { LsNewLine = Environment.NewLine; }
