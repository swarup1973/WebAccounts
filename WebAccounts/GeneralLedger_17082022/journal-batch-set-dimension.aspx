<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="journal-batch-set-dimension.aspx.cs" Inherits="WebAccounts.journal_batch_set_dimension" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="Server">

    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/journal-batch-set-dimension.js"></script>
</asp:Content>
        ...
        <div class="row">
            <div class="col">
               <p>
					...
					Setup 
					>
                    <a href="journal-batch.aspx">Journal Batch</a> 
                    >
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12 col-sm-12">
                            Batch Code: <strong id="acNumber"></strong> Batch Description: <strong id="bankName"></strong>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-3 text-center">
                                <button
                                    id="btn_cancel" onclick="window.location ='journal-batch.aspx';"
