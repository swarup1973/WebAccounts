...
<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="Server">
    ...
    <script type="text/javascript" src="js/itemmasteroverview.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" runat="Server">
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select name="select4" class="form-control" id="ddDefWarehouse" onchange="ItemmasterOverviewObject.do_populateWarehouseocation(-1,-1);">
                                    <option>Selection</option>
                                    <option>--</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="txtBBU">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="txtWarrantyPeriod">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3">
    ...
    <div class="modal fade" id="myModalVIEW" tabindex="-1" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-lg" style="height: 100%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Item Master Overview - View</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <p>
                                    <img src="item-pic.jpg" width="150" height="150" alt="Item Pic" /></p>
                            </div>
                            <div class="col-sm-3">
                                <label for="input">Notes</label>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <label for="input">Vendot Item No</label>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" disabled="disabled">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control">
                                    <option>1. FIFO</option>
                                    <option>2. LIFO</option>
                                    <option>3. Weighted Average</option>
                                    <option>4. Standard</option>
                                    <option>5. Specific</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <div class="modal-dialog" style="height: 100%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <img src="item-pic.jpg" width="400" height="400" alt="Item Picture" />
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" style="height: 100%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <p>Notes goes here Notes goes here Notes goes here Notes goes here Notes goes here</p>
                        </div>
                    </div>
                </div>
