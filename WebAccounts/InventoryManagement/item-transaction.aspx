    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <option value="item-sub-ledger-updates">Sub-ledger Updates</option>
           <option value="item-tax-updates">Tax Updates</option>
...
function showPage() {
  ...
  window.open(option + ".aspx");
                ...
                <div class="col-md-12 col-sm-12">    
                	Item Code: <strong>Display of Vendor No for the Selected Item</strong> | Item Name : <strong>Display of Name for the Selected Item</strong>
                </div>
