    ...
    do_populatewarehouseData: (obj) => {
        ...
        roletable.dataTable({
            ...
            buttons: [
                ...
                {
                    add: "Unit_Conversion", text: 'Unit Conversion', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
                ...
                {
                    add: "Item_Vendor_Price", text: 'Item-Vendor Price', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
                ...
                {
                    add: "Item_Customer_Price", text: 'Item-Customer Price', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
                ...
                {
                    add: "Item-Vendor-Discount", text: 'Item-Vendor Discount', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
                ...
                {
                    add: "Item-Customer-Discount", text: 'Item-Customer Discount', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
                ...
                {
                    add: "Purchase-Invoice-Discount", text: 'Purchase Invoice Discount', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
                ...
                {
                    add: "Sale-Invoice-Discount", text: 'Sale Invoice Discount', editor: editor, action: function () { roleaction($('.selected').attr('rowid'), 'view'); },
                    attr: {
...
var savedata = function () {
    ...
    else if ($('#txtInternalId').val().length < 1) {
        validate = false;
        $.alertable.alert(`Internal Identifier Code required.`);
        $("#txtInternalId").focus();
        return false;
    }
