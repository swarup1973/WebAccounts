...
{
    public partial class item_specific_conversion : System.Web.UI.Page
    {
        ...
        [System.Web.Services.WebMethod]
        public static string loadlookupItem(string CoCd)
        {
            string JSONString = string.Empty;
            string _catchmessage = string.Empty;
            string _ret = string.Empty;
            string _connectionstring = ConfigurationManager.ConnectionStrings["SqlString"].ToString();
            ItemConversion role = new ItemConversion();
            role._cocd = CoCd;
            DataSet ds = role.getItem(_connectionstring, ref _catchmessage);
        ...
        public static string loadStandard(string data)
        {
            ...
            string _connectionstring = ConfigurationManager.ConnectionStrings["SqlString"].ToString();
            ItemConversion ns = new ItemConversion();
            ns._cocd = cocd;
            DataSet ds = ns.getItemConversion(_connectionstring, ref _catchmessage);
        ...
        public static string doSave(string data)
        {
            ...
            ns._id = id;
            ns._cocd = cocd;
            string ItemCd = requestdata.ItemCd;
        ...
        public static string dodelete(string id)
        {
            ...
            ItemConversion vnd = new ItemConversion();
            vnd._mode = "delete";
            vnd._id = _id;
