<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="item-vendor-discount.aspx.cs" Inherits="WebAccounts.item_vendor_discount" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/item-vendor-discount.js"></script>
            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" id="btn_search" class="btn btn-secondary" onclick="VendorItemDiscountObject.do_loadvendoritemprice();">Search</button>
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="input">Currency Code</label><span class="text-danger">*</span>
                            </div>
                            <div class="col-sm-6">
