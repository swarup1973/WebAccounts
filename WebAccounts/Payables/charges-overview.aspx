<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="charges-overview.aspx.cs" Inherits="WebAccounts.Payables.charges_overview" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="Server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <title>Charges Overview</title>

    <script type="text/javascript" src="js/charges-overview.js"></script>
    <link href="../GeneralLedger/administration.css" rel="stylesheet" />
        ...
        <div class="modal-dialog" style="height:100%;">
            <div class="modal-content">
              <div class="modal-header">
                 <h5 class="modal-title">Charges Overview - New</h5>
