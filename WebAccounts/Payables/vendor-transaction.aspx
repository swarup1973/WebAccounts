    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <option value="vendor-sub-ledger-updates">Sub-ledger Updates</option>
           <option value="vendor-tax-updates">Tax Updates</option>
...
function showPage() {
  ...
  window.open(option + ".aspx");
                ...
                <div class="col-md-12 col-sm-12">    
                	Vendor Code: 1234567890 . Vendor Name: Name
                </div>
