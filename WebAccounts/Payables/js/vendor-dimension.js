...
var DimSetup = {
    ...
    do_loaddimSetupData: () => {
        ...
        if (queryString('id') != undefined || queryString("id") != null) {
            ...
            window.location.href = "vendor-dimension.aspx";
        }
        ...
        $.ajax({
            type: "POST",
            url: "vendor-dimension.aspx/doloadDimSetupData",
            data: _data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
    ...
    dosaveDimSetup: () => {
        ...
        if (validate == true) {
            ...
            var _url = "vendor-dimension.aspx/doSavedimsetup";
            $.ajax({
                type: "POST",
                url: _url,
                data: JSON.stringify(_passdata),
    ...
    do_getUserPagepermission: () => {
        ...
        DimSetup._editperm = MainObject.do_IsActionMenuPermission(DimSetup.access, 'DIMENSION', 'edit');
        DimSetup._deleteperm = MainObject.do_IsActionMenuPermission(DimSetup.access, 'DIMENSION', 'delete');
        if (queryString('menuid') != undefined || queryString("menuid") != null) {
            if (!DimSetup._createperm[0]) {
                ...
                $('#btn_save').attr('title', 'do not have permission to save Record!!!');
