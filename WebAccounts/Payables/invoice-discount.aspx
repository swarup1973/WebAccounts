<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="invoice-discount.aspx.cs" Inherits="WebAccounts.invoice_discount" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/invoice-discount.js"></script>
    <title>Purchase Invoice Discount</title>
     <style>
        .dataTables_wrapper {
            margin-top : 10px;
        }
