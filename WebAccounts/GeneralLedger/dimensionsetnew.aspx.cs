...
{
    public partial class dimensionsetnew : System.Web.UI.Page
    {
        ...
        public static string docheckdimensioncode(string dimsetId, string dimsetCd)
        {
            ...
            dim._dimSetCode = HttpContext.Current.Server.UrlDecode(dimsetCd);

            isdimensionexists = dim.checkDimensionSetcode(_connectionstring, ref _catchmessage);
        ...
        [System.Web.Services.WebMethod]
        public static string doloaddimensiondetails(string dimsetid)
        {
            string JSONString = string.Empty;
            string _catchmessage = string.Empty;
            string _ret = string.Empty;
