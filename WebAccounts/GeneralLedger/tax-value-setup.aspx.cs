...
{
    public partial class tax_value_setup : System.Web.UI.Page
    {
        ...
        public static string loadlist(string data)
        {
            ...
            taxvaluesetup vnd = new taxvaluesetup();
            vnd._mode = "getlist";
        ...
        public static string doSave(string data)
        {
            ...
            string _MinBaseValueCalc = requestdata.MinBaseValueCalc;
            string _MaxBaseValueCalc = requestdata.MaxBaseValueCalc;
            string _ValuePerOrAmt = requestdata.ValuePerOrAmt;
            string _MinSaleTaxAmt = requestdata.MinSaleTaxAmt;
            string _MaxSaleTaxAmt = requestdata.MaxSaleTaxAmt;
            string _IsBlock = requestdata.Isblock;

            vnd._SaleTaxCompId = _SaleTaxCompId;
            vnd._FromDt = _FromDt;
            vnd._ToDt = _ToDt;
            vnd._MinBaseValueCalc = _MinBaseValueCalc;
            vnd._MaxBaseValueCalc = _MaxBaseValueCalc;
            vnd._ValuePerOrAmt = _ValuePerOrAmt;
            vnd._MinSaleTaxAmt = _MinSaleTaxAmt;
            vnd._MaxSaleTaxAmt = _MaxSaleTaxAmt;
