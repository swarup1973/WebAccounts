            ...
            <div class="col">
                <div class="card">
                    <div class="card-body table-responsive">
								<strong>Budget Allocation Group Code:</strong><span id="itemcode"></span>&nbsp;<strong>Budget Allocation Group Description:</strong> <span id="itemdes"></span>
                                <!-- start role table -->
        ...
        <div class="modal-dialog" style="height:100%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
						<div class="col-sm-6">
							<label for="input">Select Dimension</label>
                            <span class="requ">(*)</span>
						</div>
						<div class="col-sm-6">
						    <select id="ddDimension" onchange="populateDimensionValue();">
                            </select>    
                    ...
                    <div class="form-group row">
						<div class="col-sm-6">
							<label for="input">Select Dimension Value</label>
                            <span class="requ">(*)</span>
						</div>
						<div class="col-sm-6">
						      <select id="ddDimensionValue">
                            </select>   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
						     <input type="number" value="0" class="form-control" id="txtPercn" /> 
                             
				   		</div>
                        <div class="col-sm-3"><button type="button" class="btn btn-primary" onclick="adddatatotable();" id="btnAddData">Add</button> </div>
					</div>
