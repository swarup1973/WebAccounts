...
{
    public partial class tax_component_setup : System.Web.UI.Page
    {
        ...
        [System.Web.Services.WebMethod]
        public static string docheckcode(string id, string componentid, string grpid, string cocd, string module)
        {
            ...
            vnd._mode = "check";
            vnd._rowid = _id;
            vnd._SaleTaxCompId = componentid;
            vnd._SalesTaxGrpId = grpid;
            vnd._CoCd = _cocd;
        ...
        public static string doSave(string data)
        {
            ...
            vnd._CoCd = cocd;
            vnd._module = module;
            vnd._SaleTaxCompId = requestdata.componentid;
            vnd._SalesTaxGrpId = requestdata.SalesTaxGrpId;
