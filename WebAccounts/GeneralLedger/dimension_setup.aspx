<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="dimension_setup.aspx.cs" Inherits="WebAccounts.dimension_setup" %>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="col-md-12 col-sm-12">   
                       Bank Name: <strong id="bankName"></strong>.Bank Account No: <strong id="acNumber"></strong>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-4 offset-md-3 text-center">
                            <button
                            id="btn_cancel" onclick="window.location ='bank_master_overview.aspx';"
