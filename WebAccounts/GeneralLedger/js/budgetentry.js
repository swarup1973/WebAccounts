...
$(document).ready(function () {
    ...
    //BudgetEntryOverviewObject.do_checkcodeentry("GeneralLedger_BudgetRegister");
   //BudgetEntryOverviewObject.do_populateMasterDropdown();

    
    BudgetEntryOverviewObject.do_loaddata();
    BudgetEntryOverviewObject.do_getUserPagepermission();
...
var BudgetEntryOverviewObject = {
        ...
        _data = JSON.stringify({ cocd: $("#ddlCompany").val() }),
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    BudgetEntryOverviewObject.do_populateData(obj);
                },
                error: function (err) {
    ...
    do_populateData: (obj) => {
        ...
        roletable.dataTable({
            ...
            buttons: [
                ...
                {
                    add: "ViewRivisionHistory", text: 'View Rivision History', editor: editor, action: function () { otherWindow($('.selected').attr('rowid'), 'VIEWRIVISIONHISTORY'); },
                    attr: {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                ...
                if (!BudgetEntryOverviewObject._deleteperm[0]) {
        ...
        //if (!BudgetEntryOverviewObject._createperm[0]) {
        ...
        //    });
        //}
        if (!BudgetEntryOverviewObject._editperm[0]) {
        ...
        if (!BudgetEntryOverviewObject._vieweperm[0]) {
        ...
        //if (!BudgetEntryOverviewObject._budgetentrycreateperm[0]) {
        ...
        //    });
        //}
        if (!BudgetEntryOverviewObject._budgetallocationviewvieweperm[0]) {
        ...
        //if (!BudgetEntryOverviewObject.revisionentryvieweperm[0]) {
        ...
        //    });
        //}
        //if (!BudgetEntryOverviewObject.balancevariancevieweperm[0]) {
    ...
    do_getUserPagepermission: () => {
        MainObject.do_getuserpageaccess(BudgetEntryOverviewObject);
        
        BudgetEntryOverviewObject._vieweperm = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET ENTRY', 'view');
        BudgetEntryOverviewObject._createperm = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET ENTRY', 'create');
        BudgetEntryOverviewObject._editperm = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET ENTRY', 'edit');
        BudgetEntryOverviewObject._deleteperm = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET ENTRY', 'delete');
        BudgetEntryOverviewObject._budgetallocationvieweperm = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET ALLOCATION', 'view');
        BudgetEntryOverviewObject._budgetallocationviewvieweperm = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'VIEW ALLOCATION', 'view');

        BudgetEntryOverviewObject._budgetallocationmenuid = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET ALLOCATION', 'menuid');
        BudgetEntryOverviewObject._budgetallocationviewmenuid = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'VIEW ALLOCATION', 'view');

        BudgetEntryOverviewObject._budgettransfermenuid = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET TRANSFER', 'menuid');
        BudgetEntryOverviewObject._budgettransferviewmenuid = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'BUDGET TRANSFER', 'view');

        BudgetEntryOverviewObject._viewrevisionmenuid = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'VIEW REVISION HISTORY', 'menuid');
        BudgetEntryOverviewObject._viewrevisionviewwmenuid = MainObject.do_IsActionMenuPermission(BudgetEntryOverviewObject.access, 'VIEW REVISION HISTORY', 'view');
    ...
    do_loaddataedit: (id) => {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                BudgetEntryOverviewObject.rowid = response[0].RowId;
    ...
    do_loadwarehouselocation: () => {
        ...
        _data = JSON.stringify({ cocd: $("#ddlCompany").val() }),
            $.ajax({
                ...
                type: 'POST',
                data: { p_mode: "getlist", LocationCd: '', CoCd: $("#ddlCompany").val(), LocationDesc: '', WhId: BudgetEntryOverviewObject.rowid, AisleNo: -1, RackNo: -1, SelfNo: -1, BinNo: "-1", created_by: $("#txt").val(), RowId: -1 },
                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                success: function (response) {
                    var obj = response;
                    BudgetEntryOverviewObject.do_loadwarehouselocationData(obj);
                },
                error: function () {
...
function saveFinal(imgId) {
    ...
    if (parseInt(BudgetEntryOverviewObject.rowid) > 0) {
        $.ajax({

            url: apiurl + 'api/GeneralLedgerBudgetRegisterDetailseditoperation',
            type: 'POST',
            data: { mode: "update", RowId: parseInt(BudgetEntryOverviewObject.rowid), CoCd: CoCd, created_by: created_by, creator_MAC_add: creator_MAC_add, CYBud: CYBud, BudAmtUtilised: BudAmtUtilised, BalCF_ToNextPrd: BalCF_ToNextPrd, IsBlock: IsBlock, IsStop: IsStop, PrdAllo: PrdAllo, PrdDim: PrdDim },
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
            success: function (response) {
...
var otherWindow = function (countryCd, mode) {
    ...
    if (localStorage.budgetentryoverviewrowid) {
        if (mode == "VIEWRIVISIONHISTORY") {


            localStorage.clickedmenu_id = BudgetEntryOverviewObject._viewrevisionmenuid[1];
            localStorage.menu_id_premission = BudgetEntryOverviewObject._viewrevisionmenuid[1];
            ...
            //alert(BudgetEntryOverviewObject._addressdetailsmenuid[1]);
            //location.href = 'address-details.aspx?id=1&menuid=' + BudgetEntryOverviewObject._addressdetailsmenuid[1];
            location.href = 'budget-rivision-history.aspx';

        }
        if (mode == "VIEWBUDGETALLOCATION") {


            localStorage.clickedmenu_id = BudgetEntryOverviewObject._budgetallocationmenuid[1];
            localStorage.menu_id_premission = BudgetEntryOverviewObject._budgetallocationmenuid[1];
            localStorage.budgetallocationaccode = $('#addressbook').DataTable().rows('.selected').data()[0].AcCd;
            localStorage.budgetallocationaccodedesc = $('#addressbook').DataTable().rows('.selected').data()[0].AcDesc;
            localStorage.budgetallocationaccodeamt = $('#addressbook').DataTable().rows('.selected').data()[0].CYBud;
        ...
        if (mode == "BUDGETTRANSFER") {
            ...
            localStorage.clickedmenu_id = BudgetEntryOverviewObject._budgettransfermenuid[1];
            localStorage.menu_id_premission = BudgetEntryOverviewObject._budgettransfermenuid[1];
            localStorage.budgetallocationaccode = $('#addressbook').DataTable().rows('.selected').data()[0].AcCd;
            localStorage.budgetallocationaccodedesc = $('#addressbook').DataTable().rows('.selected').data()[0].AcDesc;
            localStorage.budgetallocationaccodeamt = $('#addressbook').DataTable().rows('.selected').data()[0].CYBud;
            //localStorage.itemmasteroverviewitemno = $('#addressbook').DataTable().rows('.selected').data()[0].ItemCd;
...
var roleaction = function (rowId, mode) {
    ...
    if (mode == "viewlocation") {
        BudgetEntryOverviewObject.rowid = rowId;
        showmodalview();
    ...
    if (mode == 'add') {
        companylogo = "";
        BudgetEntryOverviewObject.rowid = '-1';
        if (manualentry == true) {
    ...
    if (mode == 'edit') {
        ...
        BudgetEntryOverviewObject.rowid = rowId;
        BudgetEntryOverviewObject.do_loaddataedit(rowId);
        ...
        $.alertable.custconfirm(`Are you want to block the Record ?`, ``, `Yes`, `No`)
            .then(
                function () {
                    var _data;
                    _data = '{rowid:"' + rowId + '"}';
                    BudgetEntryOverviewObject.do_updateblockstop(rowId,'block');
        ...
        $.alertable.custconfirm(`Are you want to stop the Record ?`, ``, `Yes`, `No`)
            .then(
                function () {
                    var _data;
                    _data = '{rowid:"' + rowId + '"}';
                    BudgetEntryOverviewObject.do_updateblockstop(rowId,'stop');
...
function PopulateState() {
    BudgetEntryOverviewObject.do_populateLocationDropdown('STATE', $('#ddPincodeCountry').val(), $('#ddPincodeCounty'));
}
function PopulateCity() {
    BudgetEntryOverviewObject.do_populateLocationDropdown('CITY', $('#ddPincodeCounty').val(), $('#ddPincodeCity'));
}
...
function populatePeriodDropdown() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { CoCd: $("#ddlCompany").val(), BudgetRegisterRowId: BudgetEntryOverviewObject.rowid, ctype: ctype },
        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
        success: function (response) {
...
function revisesave() {
    ...
    RowId = BudgetEntryOverviewObject.rowid;
