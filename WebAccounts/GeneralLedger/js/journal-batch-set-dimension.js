...
var DimSetup = {
    ...
    do_loaddimSetupData: () => {
        ...
        if (queryString('id') != undefined || queryString("id") != null) {
            ...
            window.location.href = "journal-batch-set-dimension.aspx";
        }
        ...
        $.ajax({
            type: "POST",
            url: "journal-batch-set-dimension.aspx/doloadDimSetupData",
            data: _data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
    ...
    dosaveDimSetup: () => {
        ...
        if (validate == true) {
            ...
            var _url = "journal-batch-set-dimension.aspx/doSavedimsetup";
            $.ajax({
                type: "POST",
                url: _url,
                data: JSON.stringify(_passdata),
    ...
    do_getUserPagepermission: () => {
        ...
        DimSetup._createperm = MainObject.do_IsActionMenuPermission(DimSetup.access, 'DIMENSION SET-UP', 'create');
        DimSetup._editperm = MainObject.do_IsActionMenuPermission(DimSetup.access, 'DIMENSION SET-UP', 'edit');
        DimSetup._deleteperm = MainObject.do_IsActionMenuPermission(DimSetup.access, 'DIMENSION SET-UP', 'delete');
    },
