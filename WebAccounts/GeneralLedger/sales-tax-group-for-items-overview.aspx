<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="sales-tax-group-for-items-overview.aspx.cs" Inherits="WebAccounts.sales_tax_group_for_items_overview" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/sales-tax-group-for-items-overview.js"></script>
    <title>Sales Tax Group for Items: Overview</title>
</asp:Content>
        ...
        <div class="row">
            <div class="col">
                <p>
                    General Ledger
					>
					<strong>Sales Tax Group for Items: Overview</strong>
                </p>
            </div>
        </div>
                ...
                <form>
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="txt_SalesTaxGrpCd" maxlength="20" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="txt_SalesTaxGrpDesc" maxlength="100" />
                            </div>
                        </div>
