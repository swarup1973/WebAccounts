<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="customer-payment-terms.aspx.cs" Inherits="WebAccounts.customer_shipment_term" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="Server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/jsCustomerPaymentTerm.js"></script>
    <title>Customer Payment Term</title>
</asp:Content>
            ...
            <div class="col">
                <p>
                   Procurement 
					...
					Setup 
					>
					<strong>Customer Payment Term</strong>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                                <!-- start role table -->
                                <table id="Cst_payment_term_table"  class="table table-striped table-hover table-condensed projects display datatable width-100" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Code</th>
                                            <th>Description</th>
