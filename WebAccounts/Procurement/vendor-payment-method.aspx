<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="vendor-payment-method.aspx.cs" Inherits="WebAccounts.vendor_payment_method" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="Server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/jsVendorPaymentMethod.js"></script>
    <title>Vendor Payment Method</title>
</asp:Content>
            ...
            <div class="col">
                <p>
                   ...
                   Procurement
					...
					Setup
					>
					<strong>Vendor Payment Method</strong>
                </p>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                                <!-- start role table -->
                                <table id="vnd_payment_table"  class="table table-striped table-hover table-condensed projects display datatable width-100" style="width: 100%;"> <%--white-space:nowrap; display:block; overflow-x:auto; overflow-y: hidden;--%>
                                    <thead>
                                        <tr>
                                            <th>Code</th>
                                            <th>Description</th>
