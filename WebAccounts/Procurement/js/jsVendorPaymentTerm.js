...
var CustomerPaymentTermObject = {
    ...
    do_loadvendorshipment: () => {
        ...
        $.ajax({
            type: "POST",
            url: "vendor-payment-terms.aspx/loadCustomerPaymentTerm",
            data: JSON.stringify(_passdata),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
    ...
    do_populateVendorAccountShipment: (obj) => {
        ...
        var roletable = $("#Vnd_payment_term_table");
        //userstable.html("");
        ...
        var table = $('#Vnd_payment_term_table').DataTable();
    ...
    do_loaddataedit: (id) => {
        ...
        $.ajax({
            type: "POST",
            url: "vendor-payment-terms.aspx/doedit",
            data: JSON.stringify(_passdata),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
    ...
    do_getUserPagepermission: () => {
        ...
        CustomerPaymentTermObject._vieweperm = MainObject.do_IsActionMenuPermission(CustomerPaymentTermObject.access, 'Vendor Payment Terms', 'view');
        CustomerPaymentTermObject._createperm = MainObject.do_IsActionMenuPermission(CustomerPaymentTermObject.access, 'Vendor Payment Terms', 'create');
        CustomerPaymentTermObject._editperm = MainObject.do_IsActionMenuPermission(CustomerPaymentTermObject.access, 'Vendor Payment Terms', 'edit');
        CustomerPaymentTermObject._deleteperm = MainObject.do_IsActionMenuPermission(CustomerPaymentTermObject.access, 'Vendor Payment Terms', 'delete');
    },
...
var doaction = function (id, mode) {
    ...
    if (mode == 'edit') {
        ...
        $.ajax({
            type: "POST",
            url: "vendor-payment-terms.aspx/docheckdelete",
            data: _data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            ...
            $.alertable
                ...
                .then(
                    function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "vendor-payment-terms.aspx/dodelete",
                            data: _data,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                            success: function (result) {
                                if (!dochkses(result.d)) return;
                                if (result.d.toLowerCase() == "false") {
                                    window.location = "vendor-payment-terms.aspx";
                                }
                                else if (result.d.toLowerCase() == "true") {
                                    $.alertable.alert(
                                        `Unable to delete.`
...
var savedata = function () {
    ...
    //    $.ajax({
    //        type: "POST",
    //        url: "vendor-payment-terms.aspx/docheckcode",
    //        data: _data,
    //        contentType: "application/json; charset=utf-8",
    //        dataType: "json",
    //        async: false,
    ...
    if (validate == true) {
        ...
        var _url = "vendor-payment-terms.aspx/doSave";
        $.ajax({
            type: "POST",
            url: _url,
            data: JSON.stringify(_passdata),
