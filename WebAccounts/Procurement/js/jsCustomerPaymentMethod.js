...
var CustomerPaymentMethodObject = {
    ...
    do_loadvendorshipment: () => {
        ...
        $.ajax({
            type: "POST",
            url: "customer-payment-method.aspx/loadVendorShipmentMethod",
            data: JSON.stringify(_passdata),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
    ...
    do_populateVendorAccountShipment: (obj) => {
        ...
        var roletable = $("#cst_payment_table");
        //userstable.html("");
        ...
        var table = $('#cst_payment_table').DataTable();
    ...
    do_loaddataedit: (id) => {
        ...
        $.ajax({
            type: "POST",
            url: "customer-payment-method.aspx/doedit",
            data: JSON.stringify(_passdata),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
    ...
    do_getUserPagepermission: () => {
        ...
        CustomerPaymentMethodObject._vieweperm = MainObject.do_IsActionMenuPermission(CustomerPaymentMethodObject.access, 'Customer Payment Method', 'view');
        CustomerPaymentMethodObject._createperm = MainObject.do_IsActionMenuPermission(CustomerPaymentMethodObject.access, 'Customer Payment Method', 'create');
        CustomerPaymentMethodObject._editperm = MainObject.do_IsActionMenuPermission(CustomerPaymentMethodObject.access, 'Customer Payment Method', 'edit');
        CustomerPaymentMethodObject._deleteperm = MainObject.do_IsActionMenuPermission(CustomerPaymentMethodObject.access, 'Customer Payment Method', 'delete');
    },
...
var doaction = function (id, mode) {
    ...
    if (mode == 'edit') {
        ...
        $.ajax({
            type: "POST",
            url: "customer-payment-method.aspx/docheckdelete",
            data: _data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            ...
            $.alertable
                ...
                .then(
                    function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "customer-payment-method.aspx/dodelete",
                            data: _data,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: false,
                            success: function (result) {
                                if (!dochkses(result.d)) return;
                                if (result.d.toLowerCase() == "false") {
                                    window.location = "customer-payment-method.aspx";
                                }
                                else if (result.d.toLowerCase() == "true") {
                                    $.alertable.alert(
                                        `Unable to delete.`
...
var savedata = function () {
    ...
    //    $.ajax({
    //        type: "POST",
    //        url: "customer-payment-method.aspx/docheckcode",
    //        data: _data,
    //        contentType: "application/json; charset=utf-8",
    //        dataType: "json",
    //        async: false,
    ...
    if (validate == true) {
        ...
        var _url = "customer-payment-method.aspx/doSave";
        $.ajax({
            type: "POST",
            url: _url,
            data: JSON.stringify(_passdata),
