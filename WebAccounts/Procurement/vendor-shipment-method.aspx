<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="vendor-shipment-method.aspx.cs" Inherits="WebAccounts.vendor_shipment_method" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="Server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/jsVendorShipmentMethod.js"></script>
    <title>Vendor Shipment Method</title>
</asp:Content>
            ...
            <div class="col">
                <p>
                   Procurement 
					...
					Setup 
					>
					<strong>Vendor Shipment Method</strong>
                </p>
            </div>
        </div>
