<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="customer_posting_group.aspx.cs" Inherits="WebAccounts.customer_posting_group" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/customer_posting_group.js"></script>
</asp:Content>
        ...
        <div class="row">
            <div class="col">
                <p>
					...
					>
					<strong>Customer Posting</strong>
                </p>
            </div>
        </div>
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" id="cbo_AcCd_Receivable">
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
