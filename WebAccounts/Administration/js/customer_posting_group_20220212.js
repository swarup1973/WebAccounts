...
var CustomerPostingGroupObject = {
    ...
    do_populatebankpostinggroup: (obj) => {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                if (!CustomerPostingGroupObject._deleteperm) {
        ...
        if (!CustomerPostingGroupObject._createperm) {
        ...
        if (!CustomerPostingGroupObject._editperm) {
        ...
        if (!CustomerPostingGroupObject._postsetupperm) {
    ...
    do_getUserPagepermission: () => {
        ...
        CustomerPostingGroupObject._postsetupperm = MainObject.do_IsActionMenuPermission(CustomerPostingGroupObject.access, 'Customer Posting', 'view');
        CustomerPostingGroupObject._createperm = MainObject.do_IsActionMenuPermission(CustomerPostingGroupObject.access, 'Customer Posting', 'create');
        CustomerPostingGroupObject._editperm = MainObject.do_IsActionMenuPermission(CustomerPostingGroupObject.access, 'Customer Posting', 'edit');
        CustomerPostingGroupObject._deleteperm = MainObject.do_IsActionMenuPermission(CustomerPostingGroupObject.access, 'Customer Posting', 'delete');
