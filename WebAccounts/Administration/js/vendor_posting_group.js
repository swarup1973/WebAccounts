...
var VendorPostingGroupObject = {
    ...
    do_getUserPagepermission: () => {
        ...
        VendorPostingGroupObject._createperm = MainObject.do_IsActionMenuPermission(VendorPostingGroupObject.access, 'VENDOR POSTING SETUP', 'create');
        VendorPostingGroupObject._editperm = MainObject.do_IsActionMenuPermission(VendorPostingGroupObject.access, 'VENDOR POSTING SETUP', 'edit');
        VendorPostingGroupObject._deleteperm = MainObject.do_IsActionMenuPermission(VendorPostingGroupObject.access, 'VENDOR POSTING SETUP', 'delete');
        VendorPostingGroupObject._postsetupperm = MainObject.do_IsActionMenuPermission(VendorPostingGroupObject.access, 'POSTING SETUP', 'view');
        VendorPostingGroupObject._postsetupsaveperm = MainObject.do_IsActionMenuPermission(VendorPostingGroupObject.access, 'POSTING SETUP', 'create');
    },
    ...
    do_populatebankpostinggroup: (obj) => {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                if (!VendorPostingGroupObject._deleteperm[0]) {
        ...
        if (!VendorPostingGroupObject._createperm[0]) {
        ...
        if (!VendorPostingGroupObject._editperm[0]) {
        ...
        if (!VendorPostingGroupObject._postsetupperm[0]) {
    ...
    do_loaddatapostingedit: (id) => {
        if (!VendorPostingGroupObject._postsetupsaveperm[0])
        {
            $('#btnbankpost').addClass('btn btn-secondary buttons-selected buttons-remove disabled');
            $('#btnbankpost').prop("disabled", true);
            $('#btnbankpost').attr('title', 'do not have permission to save vendor posting group setup!!!');
        }
        var _data = {};
        _data["bpgid"] = VendorPostingGroupObject.hdnroleid;
        _data["cocd"] = $('#ddlCompany').val();
