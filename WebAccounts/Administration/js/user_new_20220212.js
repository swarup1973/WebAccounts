...
var UsersObject = {
    ...
    do_loadusers: () => {
       ...
       do_getUserPagepermission: () => {
        ...
        UsersObject._assignroleperm = MainObject.do_IsActionMenuPermission(UsersObject.access, 'User', 'view');
        UsersObject._applydimperm = MainObject.do_IsActionMenuPermission(UsersObject.access, 'User', 'view');
    },
    ...
    do_populateusers: (obj) => {
        ...
        if (!UsersObject._assignroleperm) {
