...
var RoleAssignment = {
    ...
    do_getUserPagepermission: () => {
        MainObject.do_getuserpageaccess(RoleUserAssignment);
        RoleUserAssignment._createperm = MainObject.do_IsActionMenuPermission(RoleUserAssignment.access, 'Role Assignment', 'create');
        RoleUserAssignment._deleteperm = MainObject.do_IsActionMenuPermission(RoleUserAssignment.access, 'Role Assignment', 'delete');
    },
    ...
    do_populateroleusers: (obj) => {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                if (!RoleUserAssignment._deleteperm) {
        ...
        if (!RoleUserAssignment._createperm) {
