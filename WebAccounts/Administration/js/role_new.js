...
var RoleObject = {
    ...
    do_populateroles: (obj) => {
            ...
            buttons: [
                ...
                },
                {
                    ...
                    attr: {
                        title: 'Assign Users',
                        id: 'Assign_userrole',
                        value: RoleObject._menuid[1]//menu id for child pages
                    },
                },
        ...
        if (!RoleObject._assignuserroleperm[0]) {
    ...
    do_getUserPagepermission: () => {
        ...
        RoleObject._assignuserroleperm = MainObject.do_IsActionMenuPermission(RoleObject.access, 'Assign Users', 'view');
        RoleObject._menuid = MainObject.do_IsActionMenuPermission(RoleObject.access, 'Assign Users', 'menuid');
...
var roleaction = function (roleid, mode) {
    ...
    if (mode == 'edit') {
       ...
       // window.location = "role_assignment.aspx?t=r";
        ...
        window.location = "role_assignment.aspx?t=r" +"&menuid=" + RoleObject._menuid[1];
