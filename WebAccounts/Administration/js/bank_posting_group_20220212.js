...
var BankPostingGroupObject = {
    ...
    do_getUserPagepermission: () => {
        ...
        BankPostingGroupObject._createperm = MainObject.do_IsActionMenuPermission(BankPostingGroupObject.access, 'Bank Posting', 'create');
        BankPostingGroupObject._editperm = MainObject.do_IsActionMenuPermission(BankPostingGroupObject.access, 'Bank Posting', 'edit');
        BankPostingGroupObject._deleteperm = MainObject.do_IsActionMenuPermission(BankPostingGroupObject.access, 'Bank Posting', 'delete');
        BankPostingGroupObject._postsetupperm = MainObject.do_IsActionMenuPermission(BankPostingGroupObject.access, 'Bank Posting', 'view');
    },
    ...
    do_populatebankpostinggroup: (obj) => {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                if (!BankPostingGroupObject._deleteperm) {
        ...
        if (!BankPostingGroupObject._createperm) {
        ...
        if (!BankPostingGroupObject._editperm) {
        ...
        if (!BankPostingGroupObject._postsetupperm) {
