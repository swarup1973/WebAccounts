...
var FixedassetsPostingGroupObject = {
    ...
    do_loadlookup: () => {
        if (!FixedassetsPostingGroupObject._postsetupsaveperm[0]) {
            $('#btnbankpost').addClass('btn btn-secondary buttons-selected buttons-remove disabled');
            $('#btnbankpost').prop("disabled", true);
            $('#btnbankpost').attr('title', 'do not have permission to save fixed assets posting group setup!!!');
        }
    ...
    do_populatebankpostinggroup: (obj) => {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                if (!FixedassetsPostingGroupObject._deleteperm[0]) {
        ...
        if (!FixedassetsPostingGroupObject._createperm[0]) {
        ...
        if (!FixedassetsPostingGroupObject._editperm[0]) {
        ...
        if (!FixedassetsPostingGroupObject._postsetupperm[0]) {
    ...
    do_getUserPagepermission: () => {
        ...
        FixedassetsPostingGroupObject._createperm = MainObject.do_IsActionMenuPermission(FixedassetsPostingGroupObject.access, 'FIXED ASSETS POSTING SETUP', 'create');
        FixedassetsPostingGroupObject._editperm = MainObject.do_IsActionMenuPermission(FixedassetsPostingGroupObject.access, 'FIXED ASSETS POSTING SETUP', 'edit');
        FixedassetsPostingGroupObject._deleteperm = MainObject.do_IsActionMenuPermission(FixedassetsPostingGroupObject.access, 'FIXED ASSETS POSTING SETUP', 'delete');
        FixedassetsPostingGroupObject._postsetupperm = MainObject.do_IsActionMenuPermission(FixedassetsPostingGroupObject.access, 'POSTING SETUP', 'view');
        FixedassetsPostingGroupObject._postsetupsaveperm = MainObject.do_IsActionMenuPermission(FixedassetsPostingGroupObject.access, 'POSTING SETUP', 'create');
    },
};
