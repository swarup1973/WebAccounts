...
var InventoryPostingGroupObject = {
    ...
    do_getUserPagepermission: () => {
        ...
        InventoryPostingGroupObject._createperm = MainObject.do_IsActionMenuPermission(InventoryPostingGroupObject.access, 'Inventory Posting', 'create');
        InventoryPostingGroupObject._editperm = MainObject.do_IsActionMenuPermission(InventoryPostingGroupObject.access, 'Inventory Posting', 'edit');
        InventoryPostingGroupObject._deleteperm = MainObject.do_IsActionMenuPermission(InventoryPostingGroupObject.access, 'Inventory Posting', 'delete');
        InventoryPostingGroupObject._postsetupperm = MainObject.do_IsActionMenuPermission(InventoryPostingGroupObject.access, 'Inventory Posting', 'view');
    },
    ...
    do_populatebankpostinggroup: (obj) => {
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                if (!InventoryPostingGroupObject._deleteperm) {
        ...
        if (!InventoryPostingGroupObject._createperm) {
        ...
        if (!InventoryPostingGroupObject._editperm) {
        ...
        if (!InventoryPostingGroupObject._postsetupperm) {
