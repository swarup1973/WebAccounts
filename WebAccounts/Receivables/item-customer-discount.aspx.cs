...
{
    public partial class item_customer_discount : System.Web.UI.Page
    {
        ...
        public static string loadvendoritemdiscountlist(string data)
        {
            ...
            customeritemdescount vnd = new customeritemdescount();
            vnd._mode = "getlist";
            vnd._custcode = requestdata.vendorcode;
