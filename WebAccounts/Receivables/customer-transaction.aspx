    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <option value="customer-sub-ledger-updates">Sub-ledger Updates</option>
           <option value="customer-tax-updates">Tax Updates</option>
...
function showPage() {
  ...
  window.open(option + ".aspx");
                ...
                <div class="col-md-12 col-sm-12">    
                	Customer Code: 1234567890 . Customer Name: Name
                </div>
