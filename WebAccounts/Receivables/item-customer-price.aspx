<%@ Page Title="" Language="C#" MasterPageFile="~/master/base.Master" AutoEventWireup="true" CodeBehind="item-customer-price.aspx.cs" Inherits="WebAccounts.item_customer_price" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentheader" runat="server">
    <script type="text/javascript" src="../Scripts/jquery-3.5.0.min.js?0"></script>
    <script type="text/javascript" src="js/item-customer-price.js"></script>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" id="btn_search" class="btn btn-secondary" onclick="CustomerItemPriceObject.do_loadvendoritemprice();">Search</button>
        ...
        <div class="modal-dialog" style="height: 100%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Item-Customer-Price - New</h5>
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="input">MRP</label><span class="text-danger">*</span>
                            </div>
                            <div class="col-sm-6">
                                <input type="number" class="form-control" id="txt_mrp" maxlength="21" pattern="^\d+(?:\.\d{1,2})?$" onchange="setTwoNumberDecimal(this);">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
