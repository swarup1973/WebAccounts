...
{
    public partial class invoice_customer_discount : System.Web.UI.Page
    {
        ...
        public static string loadlist(string data)
        {
            ...
            invoicecustomerdiscount vnd = new invoicecustomerdiscount();
            vnd._mode = "getlist";
            vnd._CoCd = cocd;
        ...
        [System.Web.Services.WebMethod]
        public static string docheckcode(string id, string invdiscountcode, string cocd, string startdate, string enddate, string curcode)
        {
            ...
            string _id = id;
            string _invdiscountcode = invdiscountcode;
            string _cocd = cocd;
            ...
            vnd._mode = "check";
            vnd._rowid = _id;
            vnd._invoicediscountcode = _invdiscountcode;
            vnd._CoCd = _cocd;
        ...
        public static string doSave(string data)
        {
            ...
            string invoicediscountcode = requestdata.invoicediscountcode;
            string currcode = requestdata.currcode;
            string minamt = requestdata.minamt;
            string maxamt = requestdata.maxamt;
            string discount = requestdata.discount;
            string discountamount = requestdata.discountamount;
            string startdate = requestdata.startdate;
            string enddate = requestdata.enddate;
            string isblock = requestdata.Isblock;


            vnd._invoicediscountcode = invoicediscountcode;
            vnd._currcode = currcode;
            vnd._minamt = minamt;
            vnd._maxamt = maxamt;
            vnd._discount = discount;
            vnd._discountamnt = discountamount;
            vnd._startdate = startdate;
