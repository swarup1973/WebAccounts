...
{
    public partial class loan_fixed_asset : System.Web.UI.Page
    {
        ...
        public static string loadlist(string data)
        {
            ...
            loanfixedasset vnd = new loanfixedasset();
            vnd._mode = "getlist";
            vnd._CoCd = cocd;
            vnd._FAId = faid;
        ...
        public static string doSave(string data)
        {
            ...
            string faid = requestdata.faid;
            string LoanDt = requestdata.LoanDt;
            ...
            string ExptReturnDt = requestdata.ExptReturnDt;
            string ActualReturnDt = requestdata.ActualReturnDt;
            ...
            vnd._ExptReturnDt = ExptReturnDt;
            vnd._ActualReturnDt = ActualReturnDt;
