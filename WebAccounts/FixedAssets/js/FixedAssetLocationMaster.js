...
$(document).ready(function () {
    ...
    FixedAssetLocationMasterObject.do_populateMasterDropdown();

    
    //FixedAssetLocationMasterObject.do_loaddata();
    FixedAssetLocationMasterObject.do_getUserPagepermission();
...
var FixedAssetLocationMasterObject = {
    ...
    do_loaddata: () => {
        ...
        var RowId, LocCd, CoCd, LocName, DimId, DimValueId, LocAddress, IsBlock, IsStop, created_by, creator_MAC_add;
        ...
        _data = JSON.stringify({ cocd: $("#ddlCompany").val() }),
            ...
            $.ajax({
                url: apiurl + 'api/FixedAssetLocationMasteroperation',
                type: 'POST',
                data: { p_mode: "getlist", RowId: -1, LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },

                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                success: function (response) {
                    var obj = response;
                  
                    FixedAssetLocationMasterObject.do_populateData(obj);
                },
                error: function (err) {
    ...
    do_populateData: (obj) => {
        ...
        var editor = new $.fn.dataTable.Editor({
            table: "#addressbook",
            fields: [
                { label: "LocCd", name: "LocCd" },
                { label: "LocName", name: "LocName" },
                { label: "dimDesc", name: "dimDesc" },
                { label: "valueDesc", name: "valueDesc" },
        ...
        table.on('select', function () {
            ...
            if (selectedRows == 1) {
                ...
                if (!FixedAssetLocationMasterObject._deleteperm[0]) {
        ...
        if (!FixedAssetLocationMasterObject._createperm[0]) {
        ...
        if (!FixedAssetLocationMasterObject._editperm[0]) {
        ...
        if (!FixedAssetLocationMasterObject._vieweperm[0]) {
        ...
        if (!FixedAssetLocationMasterObject._accountmapvieweperm[0]) {
    ...
    do_getUserPagepermission: () => {
        MainObject.do_getuserpageaccess(FixedAssetLocationMasterObject);
        
        FixedAssetLocationMasterObject._vieweperm = MainObject.do_IsActionMenuPermission(FixedAssetLocationMasterObject.access, 'FIXED ASSETS LOCATION', 'view');
        FixedAssetLocationMasterObject._createperm = MainObject.do_IsActionMenuPermission(FixedAssetLocationMasterObject.access, 'FIXED ASSETS LOCATION', 'create');
        FixedAssetLocationMasterObject._editperm = MainObject.do_IsActionMenuPermission(FixedAssetLocationMasterObject.access, 'FIXED ASSETS LOCATION', 'edit');
        FixedAssetLocationMasterObject._deleteperm = MainObject.do_IsActionMenuPermission(FixedAssetLocationMasterObject.access, 'FIXED ASSETS LOCATION', 'delete');
    ...
    do_populateMasterDropdown: () => {
        ...
        $.ajax({
            ...
            url: apiurl + 'api/FixedAssetLocationMasteroperation',
            type: 'POST',
            data: { p_mode: "dimension", RowId: -1, LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },
    ...
    do_loaddataedit: (id) => {
        ...
        $.ajax({
            url: apiurl + 'api/FixedAssetLocationMasteroperation',
            type: 'POST',
            data: { p_mode: "edit", RowId: id, LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },
            ...
            success: function (response) {
                ...
                FixedAssetLocationMasterObject.rowid = response[0].RowId;
                $("#txtCode").val(response[0].LocCd);
                $("#txtAddress").val(response[0].LocAddress);
                $("#txtName").val(response[0].LocName);
                $("#ddDimension").val(response[0].DimId);
                //$("#ddDimensionValue").val(response[0].DimValueId);
                populatedimensionvalue((response[0].DimValueId));
    ...
    do_loadwarehouselocation: () => {
        ...
        _data = JSON.stringify({ cocd: $("#ddlCompany").val() }),
            $.ajax({
                ...
                type: 'POST',
                data: { p_mode: "getlist", LocationCd: '', CoCd: $("#ddlCompany").val(), LocationDesc: '', WhId: FixedAssetLocationMasterObject.rowid, AisleNo: -1, RackNo: -1, SelfNo: -1, BinNo: "-1", created_by: $("#txt").val(), RowId: -1 },
                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                success: function (response) {
                    var obj = response;
                    FixedAssetLocationMasterObject.do_loadwarehouselocationData(obj);
                },
                error: function () {
...
function saveFinal(imgId) {
    ...
    LocCd = $("#txtCode").val();
    LocName = $("#txtName").val();
    DimId = $("#ddDimension").val();
    DimValueId = $("#ddDimensionValue").val();
    LocAddress = $("#txtAddress").val();
    ...
    if (parseInt(FixedAssetLocationMasterObject.rowid) > 0) {
        $.ajax({

            url: apiurl + 'api/FixedAssetLocationMasteroperation',
            type: 'POST',
            data: { p_mode: "update", RowId: parseInt(FixedAssetLocationMasterObject.rowid), LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },
            ...
            success: function (response) {
                ...
                if (response[0].msg == "true") {
                    ...
                    $.alertable.alert(`Data updated successfully.`, ``, `Ok`, ``).then(function () {
                        window.location = "fixed-assets-location.aspx";
                    });
                }
                else {
        ...
        $.ajax({
            ...
            url: apiurl + 'api/FixedAssetLocationMasteroperation',
            type: 'POST',
            data: { p_mode: "create", RowId: -1, LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },
...
var otherWindow = function (countryCd, mode) {
    ...
    if (localStorage.fagrouprowid) {
        if (mode == "faitem") {
            ...
            localStorage.menu_id_premission = FixedAssetLocationMasterObject._accountmapmenuid[1];
            localStorage.clickedmenu_id = FixedAssetLocationMasterObject._accountmapmenuid[1];
...
var roleaction = function (rowId, mode) {
    ...
    if (mode == "viewlocation") {
        FixedAssetLocationMasterObject.rowid = rowId;
        showmodalview();

    }
    if (mode == 'add') {
        companylogo = "";
        FixedAssetLocationMasterObject.rowid = '-1';
        showmodal();
        $('.modal-title').html('Fixed Assets Location - New');
    ...
    if (mode == 'edit') {
        ...
        $('.modal-title').html('Fixed Assets Location - Edit');
        $('#cbBlock').show();
        datablank();
        if (!FixedAssetLocationMasterObject._deleteperm[0]) {
        ...
        $('#txtCode').prop("disabled", true);
        FixedAssetLocationMasterObject.rowid = rowId;
        FixedAssetLocationMasterObject.do_loaddataedit(rowId);
        
    }
    else if(mode == 'view') {
        showmodal();
        datablank();
        $('.modal-title').html('Fixed Assets Location - View');
        $('#cbBlock').show();
       // $('#btnDelete').show();
        // $('#btnEdit').show();
        if (!FixedAssetLocationMasterObject._deleteperm[0]) {
            ...
            .then(
                function () {
                    ...
                    $.ajax({
                        ...
                        url: apiurl + 'api/FixedAssetLocationMasteroperation',
                        type: 'POST',
                        data: { p_mode: "delete", RowId: rowId, LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },
                        contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                        success: function (response) {
...
function PopulateState() {
    FixedAssetLocationMasterObject.do_populateLocationDropdown('STATE', $('#ddPincodeCountry').val(), $('#ddPincodeCounty'));
}
function PopulateCity() {
    FixedAssetLocationMasterObject.do_populateLocationDropdown('CITY', $('#ddPincodeCounty').val(), $('#ddPincodeCity'));
}
...
function populatedimensionvalue(id) {
    var RowId, LocCd, CoCd, LocName, DimId, DimValueId, LocAddress, IsBlock, IsStop, created_by, creator_MAC_add;

    RowId = $("#ddDimension").val();
    IsBlock = 0;
    IsStop = 0;
    creator_MAC_add = ipaddress;
    created_by = $("#txt").val();
    ...
    $.ajax({
        ...
        url: apiurl + 'api/FixedAssetLocationMasteroperation',
        type: 'POST',
        data: { p_mode: "dimensionvalue", RowId: RowId, LocCd: LocCd, CoCd: CoCd, LocName: LocName, DimId: DimId, DimValueId: DimValueId, LocAddress: LocAddress, IsStop: IsStop, IsBlock: IsBlock, created_by: created_by, creator_MAC_add: creator_MAC_add },
