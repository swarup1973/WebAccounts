    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <option value="sub-ledger-updates">Sub-ledger Updates</option>
...
function showPage() {
  ...
  window.open(option + ".aspx");
                ...
                <div class="col-md-12 col-sm-12">    
                	FA Code: Display of FA No for the Selected FA Account . FA Description: Display of Description for the Selected FA Account
                </div>
