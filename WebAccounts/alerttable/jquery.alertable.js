...
if (jQuery)
  (function ($) {
    ...
    function custshow(type, message, options, oktxt, notxt) {
      var defer = $.Deferred();
      ...
      // Button html change
      if (oktxt != undefined && oktxt != "undefined" && oktxt != "")
        $(okButton).html(oktxt);
      if (notxt != undefined && notxt != "undefined" && notxt != "")
        $(cancelButton).html(notxt);
    ...
    $.alertable = {
      ...
      // Custom Confirm
      custconfirm: function (message, options, oktxt, notxt) {
        return custshow("confirm", message, options, oktxt, notxt);
      },
      ...
      defaults: {
        ...
        modal:
          ...
          '<div class="alertable-header"><h3><i class="fa fa-info-circle"></i> Alert</h3></div>' +
