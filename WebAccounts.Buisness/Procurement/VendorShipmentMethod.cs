...
{
    public class VendorShipmentMethod
    {
        ...
        public DataSet GetVendorMethod(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "get_vendorshipment_method", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
                str_catchmessage = "[Vendor_Shipment.cs:GetRoleCenter]" + expErr.Message;
            }
            finally { }
            return ds;
        }
        ...
        public DataSet Operation(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                SqlRecordParams.Add(new SqlParameter("@VenShipMethodCd", SqlDbType.VarChar) { Value = ((string.Empty == this.MethodCd) ? (object)DBNull.Value : this.MethodCd) });
                SqlRecordParams.Add(new SqlParameter("@VenShipMethodName", SqlDbType.VarChar) { Value = ((string.Empty == this.MethodDesc) ? (object)DBNull.Value : this.MethodDesc) });
                SqlRecordParams.Add(new SqlParameter("@Block", SqlDbType.Bit) { Value = ((this.IsBlock) ? 1 : 0) });
                SqlRecordParams.Add(new SqlParameter("@ShipMethodCd", SqlDbType.VarChar) { Value = ((string.Empty == this.VC) ? (object)DBNull.Value : this.VC) });
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "save_vendorshipment_method", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
                str_catchmessage = "[Vendor_Shipment.cs:Operation]" + expErr.Message;
            }
            finally { }
            return ds;
        }
        ...
        public bool check(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                dt = DataHelper.ExecuteDataset(str_ConnString, "save_vendorshipment_method", SqlRecordParams.ToArray()).Tables[0];
            ...
            {
                dt = null;
                str_catchmessage = "[Vendor_Shipment.cs:check]" + expErr.Message;
            }
            finally { }
            return isexist;
        }
