...
{
    public class customeritemdescount
    {
        ...
        public string _discountperunit = string.Empty;
        ...
        public DataSet Operation(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                SqlRecordParams.Add(new SqlParameter("@p_discountperunit", SqlDbType.VarChar) { Value = ((string.Empty == this._discountperunit) ? (object)DBNull.Value : Convert.ToDecimal(this._discountperunit)) });
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "CustomerItemDiscount_operation", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
