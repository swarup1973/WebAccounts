...
namespace WebAccounts.Buisness
{
    public class ItemConversion
    {
        ...
        public string _ItemCd = string.Empty;
        ...
        public DataSet getItem(string str_ConnString, ref string str_catchmessage)
        {
            DataSet ds = null;
            try
            {
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "getItem", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
                str_catchmessage = "[ItemConversion.cs:Operation]" + expErr.Message;
            }
            finally { }
            return ds;
        }

        public DataSet getItemConversion(string str_ConnString, ref string str_catchmessage)
        {
            DataSet ds = null;
            try
            {
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "getItemSpecificConversion", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
        ...
        public DataSet Operation(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                SqlRecordParams.Add(new SqlParameter("@ItemCd", SqlDbType.VarChar) { Value = ((string.Empty == this._ItemCd) ? (object)DBNull.Value : this._ItemCd) });
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "save_ItemConversion", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
        ...
        public bool check(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                //dt = DataHelper.ExecuteDataset(str_ConnString, "save_no_sequence", SqlRecordParams.ToArray()).Tables[0];
                dt = DataHelper.ExecuteDataset(str_ConnString, "save_ItemConversion", SqlRecordParams.ToArray()).Tables[0];
