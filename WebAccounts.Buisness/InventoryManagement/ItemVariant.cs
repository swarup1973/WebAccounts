...
namespace WebAccounts.Buisness
{
    public class ItemVariant
    {
        ...
        public string _VariantName = string.Empty;
        ...
        public DataSet Operation(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                SqlRecordParams.Add(new SqlParameter("@VariantName", SqlDbType.VarChar) { Value = ((string.Empty == this._VariantName) ? (object)DBNull.Value : this._VariantName) });
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "itemvariant_operation", SqlRecordParams.ToArray());
            }
        ...
        public bool check(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                dt = DataHelper.ExecuteDataset(str_ConnString, "itemvariant_operation", SqlRecordParams.ToArray()).Tables[0];
