...
namespace WebAccounts.Buisness
{
    public class locationtransfer
    {
        ...
        public string _TransfDt = string.Empty;
        ...
        public DataSet Operation(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                SqlRecordParams.Add(new SqlParameter("@TransfDt", SqlDbType.Date) { Value = ((string.Empty == this._TransfDt) ? (object)DBNull.Value : this._TransfDt) });
                ...
                ds = DataHelper.ExecuteDataset(str_ConnString, "FixedAsset_LocationTransfer_operation", SqlRecordParams.ToArray());
            }
            catch (Exception expErr)
            {
                ds = null;
                str_catchmessage = "[location_transfer.cs:Operation]" + expErr.Message;
            }
            finally { }
            return ds;
        }
        ...
        public bool check(string str_ConnString, ref string str_catchmessage)
        {
            ...
            try
            {
                ...
                dt = DataHelper.ExecuteDataset(str_ConnString, "FixedAsset_LocationTransfer_operation", SqlRecordParams.ToArray()).Tables[0];
